...
- (void)viewDidLoad {
    ...
    // chart
    WYPieChartView *chart = [[WYPieChartView alloc] initWithFrame:CGRectMake(0, 60, CGRectGetWidth(self.view.frame), 175) title:@"244" chartType:WYPieChartViewTypeCustom];
    [self.view addSubview:chart];
    chart.backgroundColor = [UIColor groupTableViewBackgroundColor];
    ...
    // chart1
    WYPieChartView *chart1 = [[WYPieChartView alloc] initWithFrame:CGRectMake(0, 260, CGRectGetWidth(self.view.frame), 500) title:@"金额" chartType:WYPieChartViewTypeNormal];
    [self.view addSubview:chart1];
    chart1.backgroundColor = [UIColor groupTableViewBackgroundColor];
